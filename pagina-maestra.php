...
<nav class="art-nav clearfix">
    <ul class="art-hmenu"><li><a href="http://cooperativatapalpapueblomagico.com/">Quienes Somos</a></li><li><a href="pagina-maestra.php" class="active">Pagina Maestra</a></li><li><a href="contactanos.php">Contactanos</a></li></ul> 
    </nav>
                ...
                <div class="art-content-layout">
                    <div class="art-content-layout-row">
                        <div class="art-layout-cell art-content clearfix"><article class="art-post art-article">
                                <h2 class="art-postheader"><span class="art-postheadericon">Pagina Maestra</span></h2>
                                                
                                <div class="art-postcontent art-postcontent-0 clearfix"><div class="art-content-layout-wrapper layout-item-0">
<div class="art-content-layout layout-item-1">
    <div class="art-content-layout-row">
    <div class="art-layout-cell layout-item-2" style="width: 100%" >
        <p>campo de texto 100%</p>
    </div>
    </div>
</div>
</div>
...
<div class="art-content-layout layout-item-1">
    ...
    <div class="art-layout-cell layout-item-2" style="width: 50%" >
        <p>campo de texto 50%</p>
    </div><div class="art-layout-cell layout-item-2" style="width: 50%" >
        <p>campo de texto &nbsp;50%<br></p>
    </div>
    </div>
</div>
</div>
